...
# print(a+b)
# can't add a and b, because the shapes are not matching
if a.shape != b.shape:
    print(True)  # this is True
...
# now it works because a and b have matching shapes


# 11. Print a and d. Notice the difference and relation of the two array in terms of the values? Explain.
print(a)
print(d)
# a is an a 3-dimensional array of integers, b 3-dimensional array of floats
