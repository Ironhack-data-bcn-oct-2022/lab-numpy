...
print(a.shape == b.shape) # False, cannot add a and b because they have different shapes 
...
print (f"a: {a}, d: {d}") 
# a has integers and d has floats. 
...
print(e== a)
print(e, a)
# e equals a even though e holds floats and a holds integers 
...
stringy= []
for n in np.nditer(f): 
    stringy.append(str(n))
print(stringy)
