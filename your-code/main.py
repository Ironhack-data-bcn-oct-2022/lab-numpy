...
# No, because they should have the same shape.
...
#Array 'd' is equal to 'a' but adding 1 to each element of the array (array 'c').
...
print(e)
# It is the same, because it is only multiplying each element by 1.
